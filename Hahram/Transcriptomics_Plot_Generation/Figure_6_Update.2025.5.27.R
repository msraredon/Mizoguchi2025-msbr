Figure_6_All_Genes <- c("Cxcl2", "Cxcl3", "Cxcl6", "Cxcl1", "Il1a",	"Ereg", "Areg", "Hbegf","Angptl4", "Asf1b",	"Cish", "Selenoi", "Mastl", "Ska3", "Trip13", "Rrm2",	"Gen1",	"Spc25", "Pbk", "Ptgs2",  "Adtrp", "Pde4c.1", "Odc1", "Ptgr1", "Lyar", "Depdc1b",	  "Zc3h12a", "Cnfn", "Melk", "Acot7", "Nfkbia", "Tnfaip3", "Mms22l", "Fen1", "Ckap2l", "Ska1", "Rpa2",	"Arhgap11a",	"Ncapg2", "Neto2", "Exo1", "Trmt61a", "Taf4b", "Atf3", "Mybl2",	"Gins1",	"Mcm5",	"Ube2c", "Prc1", "Igf1r", "Ldlr", "Nptn", "Lrp8", "F2rl2", "Aurka", "Plaur", "Tnfrsf12a", "Itga6",	"Hras", "Il24", "Lamb3",	"Nrg1", "Rtn4", "Vasp")
...
png(file = 'Figure_6_Heatmap.2025.5.27.png', width=8.5, height=6, units = 'in',res=300, type = "cairo")
...
Figure_7_All_Genes<- c("Ebf1",	"Bcl6",	"Bhlhe40",	"Litaf",	"Camta1",	"Zbtb20",	"Runx1",	"Epas1",	"Elf3",	"Foxo1",	"Serpine1",	"Acap1",	"Ldlrad4",	"Pmepa1",	"Entpd4", "Ppp1r14a",	"Sema4g",	"Itpr1",	"Cxcr4",	"Ackr3",	"Plxna2",	
                       ...
                       "Smad7",	"Dlc1",	"Wwc2",	"Zfp36l2",	"Vim",	"Pik3cb", "Prom1",	"Krt7",	"Pik3c2a",	"Furin",	"Sulf1", "Aqp5")


Figure_7_All_Genes_Select <- c("Ebf1",	"Bcl6",	"Bhlhe40",	"Litaf",	"Camta1",	"Zbtb20",	"Runx1",	"Epas1",	"Elf3",	"Foxo1","Cxcr4",	"Ackr3",	"Plxna2", "Bnip3",	"Ltbp3",	"Fzd2",	"Ephb2", "Wfdc1",	"Mmp7",	"Lamb2",	"Tgfbi", "Bmp6",	"Vegfa",	"Efnb2",	"Mfge8",	"Vtcn1",	"Igfbp3",	"Dlk2",	"Itgb6", "Itgav", "St6gal1",	"Camk2n1", "Smad7",	"Dlc1",	"Wwc2",	"Zfp36l2",	"Vim",	"Pik3cb", "Prom1",	"Krt7",	"Pik3c2a",	"Furin",	"Sulf1", "Aqp5")
