####Finding Specific Markers For Only One Condition At A Time
...
StartingOver5D<- StartingOver5D %>% filter (p_val_adj < 0.05) %>% filter (pct.1 >= 0.1) %>%  top_n(900, power)
...
FiveDayOverStart<- FiveDayOverStart %>% filter (p_val_adj < 0.05) %>% filter (pct.1 >= 0.1) %>%  top_n(900, power)
...
EmbryoOverFiveDay<- EmbryoOverFiveDay %>% filter (p_val_adj < 0.05) %>% filter (pct.1 >= 0.1) %>%  top_n(900, power)
...
EmbryoOverP0<- EmbryoOverP0 %>% filter (p_val_adj < 0.05) %>% filter (pct.1 >= 0.1) %>%  top_n(900, power)
...
EmbryoOverP3<- EmbryoOverP3 %>% filter (p_val_adj < 0.05) %>% filter (pct.1 >= 0.1) %>%  top_n(900, power)
...
EmbryoOver24Hr<- EmbryoOver24Hr %>% filter (p_val_adj < 0.05) %>% filter (pct.1 >= 0.1) %>%  top_n(900, power)
...
EmbryoOverStart<- EmbryoOverStart %>% filter (p_val_adj < 0.05) %>% filter (pct.1 >= 0.1) %>%  top_n(900, power)
...
Eng24HrOverEmbryo<- Eng24HrOverEmbryo %>% filter (p_val_adj < 0.05) %>% filter (pct.1 >= 0.1) %>%  top_n(900, power)
...
Eng24HrOverStart<- Eng24HrOverStart %>% filter (p_val_adj < 0.05) %>% filter (pct.1 >= 0.1) %>%  top_n(900, power)
...
Eng24HrOverP0<- Eng24HrOverP0 %>% filter (p_val_adj < 0.05) %>% filter (pct.1 >= 0.1) %>%  top_n(900, power)
...
Eng24HrOverP3<- Eng24HrOverP3 %>% filter (p_val_adj < 0.05) %>% filter (pct.1 >= 0.1) %>%  top_n(900, power)
...
Eng24HrOver5D<- Eng24HrOver5D %>% filter (p_val_adj < 0.05) %>% filter (pct.1 >= 0.1) %>%  top_n(900, power)
...
P0OverEmbryo<- P0OverEmbryo %>% filter (p_val_adj < 0.05) %>% filter (pct.1 >= 0.1) %>%  top_n(900, power)
...
P0OverStart<- P0OverStart %>% filter (p_val_adj < 0.05) %>% filter (pct.1 >= 0.1) %>%  top_n(900, power)
...
P0OverP3<- P0OverP3 %>% filter (p_val_adj < 0.05) %>% filter (pct.1 >= 0.1) %>%  top_n(900, power)
...
P0Over24Hr<- P0Over24Hr %>% filter (p_val_adj < 0.05) %>% filter (pct.1 >= 0.1) %>%  top_n(900, power)
...
P0OverFiveDay<- P0OverFiveDay %>% filter (p_val_adj < 0.05) %>% filter (pct.1 >= 0.1) %>%  top_n(900, power)
...
P3OverEmbryo<- P3OverEmbryo %>% filter (p_val_adj < 0.05) %>% filter (pct.1 >= 0.1) %>%  top_n(900, power)
...
P3OverStart<- P3OverStart %>% filter (p_val_adj < 0.05) %>% filter (pct.1 >= 0.1) %>%  top_n(900, power)
...
P3OverP0<- P3OverP0 %>% filter (p_val_adj < 0.05) %>% filter (pct.1 >= 0.1) %>%  top_n(900, power)
...
P3Over24Hr<- P3Over24Hr %>% filter (p_val_adj < 0.05) %>% filter (pct.1 >= 0.1) %>%  top_n(900, power)
...
P3OverFiveDay<- P3OverFiveDay %>% filter (p_val_adj < 0.05) %>% filter (pct.1 >= 0.1) %>%  top_n(900, power)
...
my.orderA <- c("Embryogenesis", "St. Dclk1", "P0-2D", 
               "P3-2D", "Engineered-24Hr", "Engineered-FiveDay")
my.orderB <- c('frl1', 'frl2', 'NRL19', 
               'St-1', 'St-2', 'St-3', 
               'P0-1', 'P0-2', 'P0-3', 
               'P3-1', 'P3-2', 'P3-3', 
               'BDL1', 'BDL2', 'BDL3', 
               'LEP_DL1', 'LEP_DL2', 'LEP_DL3')

merged.obj$SampleRearranged <- factor(x = merged.obj$Sample, levels = my.orderB)
merged.obj$ConditionRearranged <- factor(x = merged.obj$Condition, levels = my.orderA)
...
downsampled$ConditionRearranged <- factor(x = downsampled$Condition, levels = my.orderA)
downsampled$SampleRearranged <- factor(x = downsampled$Sample, levels = my.orderB)
col.pal <- list()
col.pal$Condition <- c('red','blue', 'green', 'yellow', 'purple', 'orange')
col.pal$SampleRearranged <- c('orange','purple','yellow',
                              'brown3', 'gray', 'pink', 
                              'green3', 'red3', 'magenta', 
                              '#A3C3D9', '#FBAF00', '#574B60',
                              '#E84855', '#E0E0E2','#4C86A8',
                              '#537A5A', '#795C5F', '#E2ADF2') 
names(col.pal$Condition) <- c("Embryogenesis", "St. Dclk1", "Engineered-P0", 
                              "Engineered-P3", "Engineered-3D", "Engineered-FiveDay") 
names(col.pal$SampleRearranged) <-  c('frl1', 'frl2', 'NRL19', 
                                      'St-1', 'St-2', 'St-3', 
                                      'P0-1', 'P0-2', 'P0-3', 
                                      'P3-1', 'P3-2', 'P3-3', 
                                      'BDL1', 'BDL2', 'BDL3', 
...
CustomHeatmapOnly3(object = downsampled,
                   ...
                   #tertiary.cols = col.pal$SampleRearranged, # Needs to be a named list of colors
                   #quarternary.cols = NULL, # not used in this specific function
                   features = P0Int4[1:23], # defined above, customize
                   labels = c('Condition', 'Sample'), # Needs to ordered IDENTICALLY to primary, secondary, tertiary, above, or will produce inaccurately labeled plot
                   selected.row.anotations=P0Int4[1:23],
                   selected.label.size = 10,
                   use.scale.data = T,
                   range.frac = 0.35)
dev.off()
...
#                    #tertiary.cols = col.pal$SampleRearranged, # Needs to be a named list of colors
#                    #quarternary.cols = NULL, # not used in this specific function
#                    features = P0Int4[51:100], # defined above, customize
#                    labels = c('Condition', 'Sample'), # Needs to ordered IDENTICALLY to primary, secondary, tertiary, above, or will produce inaccurately labeled plot
#                    selected.row.anotations=P0Int4[51:100],
#                    selected.label.size = 10,
#                    use.scale.data = T,
#                    range.frac = 0.35)
# dev.off()
...
CustomHeatmapOnly3(object = downsampled,
                   ...
                   #tertiary.cols = col.pal$SampleRearranged, # Needs to be a named list of colors
                   #quarternary.cols = NULL, # not used in this specific function
                   features = P3Int2[1:50], # defined above, customize
                   labels = c('Condition', 'Sample'), # Needs to ordered IDENTICALLY to primary, secondary, tertiary, above, or will produce inaccurately labeled plot
                   selected.row.anotations=P3Int2[1:50],
                   selected.label.size = 10,
                   use.scale.data = T,
                   range.frac = 0.35)
dev.off()
...
CustomHeatmapOnly3(object = downsampled,
                   ...
                   #tertiary.cols = col.pal$SampleRearranged, # Needs to be a named list of colors
                   #quarternary.cols = NULL, # not used in this specific function
                   features = Eng24HrInt4[1:46], # defined above, customize
                   labels = c('Condition', 'Sample'), # Needs to ordered IDENTICALLY to primary, secondary, tertiary, above, or will produce inaccurately labeled plot
                   selected.row.anotations=Eng24HrInt4[1:46],
                   selected.label.size = 10,
                   use.scale.data = T,
                   range.frac = 0.35)
dev.off()
...
#                    labels = c('Condition', 'Sample'), # Needs to ordered IDENTICALLY to primary, secondary, tertiary, above, or will produce inaccurately labeled plot
#                    selected.row.anotations=Eng24HrInt4[101:50],
#                    selected.label.size = 10,
#                    use.scale.data = T,
#                    range.frac = 0.35)
# dev.off()
...
#                    #tertiary.cols = col.pal$SampleRearranged, # Needs to be a named list of colors
#                    #quarternary.cols = NULL, # not used in this specific function
#                    features = Eng24HrInt4[151:200], # defined above, customize
#                    labels = c('Condition', 'Sample'), # Needs to ordered IDENTICALLY to primary, secondary, tertiary, above, or will produce inaccurately labeled plot
#                    selected.row.anotations=Eng24HrInt4[151:200],
#                    selected.label.size = 10,
#                    use.scale.data = T,
#                    range.frac = 0.35)
# dev.off()
...
CustomHeatmapOnly3(object = downsampled,
                   ...
                   #tertiary.cols = col.pal$SampleRearranged, # Needs to be a named list of colors
                   #quarternary.cols = NULL, # not used in this specific function
                   features = FiveDayInt4[151:163], # defined above, customize
                   labels = c('Condition', 'Sample'), # Needs to ordered IDENTICALLY to primary, secondary, tertiary, above, or will produce inaccurately labeled plot
                   selected.row.anotations=FiveDayInt4[151:163],
                   selected.label.size = 10,
                   use.scale.data = T,
                   range.frac = 0.35)
dev.off()